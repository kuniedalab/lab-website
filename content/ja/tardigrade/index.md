...
sections:
  - block: markdown
    content:
      title: クマムシとは？
      text: |
        <video width="600" height="360" muted autoplay controls preload="true">
          <source src="walking.mov" type="video/mp4">
        ...
        <div class="faq">
          ...
          <details>
            <summary style="color: MediumSlateBlue">クマムシはどうしてそんなに耐性が強いの？</summary>
          ...
          <details>
            <summary style="color: MediumSlateBlue">クマムシを研究するとナニが分かるの？</summary>
